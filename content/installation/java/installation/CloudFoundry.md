...
*Note:* If the file you downloaded is automatically given a .zip extension, simply rename it to `contrast-security-service-broker-#.#.#.pivotal`
...
| Organization UUID            | The organization the application will belong to        |
