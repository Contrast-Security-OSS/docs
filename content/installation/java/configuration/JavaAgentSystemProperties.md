...
| contrast.override.appname | Sets the application name; this name is reported to Contrast. <br> **DEFAULT VALUE:** determined by scanning web.xml</br> <br>Note: This property is being deprecated in favor of the new property application.name .</br> <br>See One Application per JVM for more information. TODO link</br> |
...
| contrast.standalone.appname | Indicates the application is a standalone application with the provided name. <br>**DEFAULT VALUE:** none, must be set</br> <br>Note: This property is being deprecated in favor of the new property application.name .</br> <br>See One JVM, One Application for more information. TODO link</br>|
