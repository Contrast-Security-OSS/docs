...
| DetectPotentialSecurityControls          | true (default) or false.  All signatures will be checked if they are potential security validator or sanitizer as the code is JIT compiled.  Set it to "false" to slightly improve start-up performance or bypass issues with this feature.
