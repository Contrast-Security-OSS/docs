...
**This is a one-time configuration step.** Once it's done, you're connected to the Contrast software distribution pipeline, and can solely manage it through your distribution's package manager. You can check if you've already completed this step by looking for presence of the repo definition file:

* **Ubuntu/Debian**
  * /etc/apt/sources.list.d/contrast.list

* **Centos/Redhat**
  * /etc/yum.repos.d/contrast.repo
