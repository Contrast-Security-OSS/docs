...
tags: "EOP upgrade install installation backup"
-->
...
The upgrade process is identical to the [installation process](admin_tsinstall.html#install); however, the administrator performing the upgrade will be asked whether to update an existing installation or perform a new installation. Customers should choose to update an existing installation. 
