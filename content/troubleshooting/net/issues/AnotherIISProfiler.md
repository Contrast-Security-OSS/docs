...
To resolve the issue, Contrast implemented profiler chaining that allows Contrast to run side-by-side with another profiling tool. To enable profiling, see the `agent.dotnet.enable_chaining` [configuration setting](installation-netconfig.html#net-yaml).
