...
* **Make sure that credentials in 'contrast_security.yaml' belong to an account with permission to view findings for the application you are attempting to run with Contrast.** You may need to check with your Contrast administrator.
