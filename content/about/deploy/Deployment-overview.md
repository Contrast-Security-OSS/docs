...
* **DevOps/Automation Lead:** Works with Contrast on automating agent deployments/upgrades and on integrating with existing DevOps processes and tools (DevSecOps).
