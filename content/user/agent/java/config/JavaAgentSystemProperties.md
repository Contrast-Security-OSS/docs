...
| contrast.level | Set the log level for diagnostic logging. Values include: *trace*, *debug*, *info*, *warn*, *error*, and *fatal*. The default is *debug*.|
...
|-------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 ...
 | contrast.sampling | Enable and configure *sampling mode*.
