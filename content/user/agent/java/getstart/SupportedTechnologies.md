...
JRockit 1.5, 1.6 (update 95+ or R28.3.6+), 1.7 | GlassFish 3, 4 | Struts, Struts 2
...
* We only test WebSphere on Windows and Linux, and can only offer limited support for zSeries, and AIX environments.
