...
* We only test WebSphere on Windows and Linux, and can only offer limited support for zSeries, and AIX environments. Customers using WebSphere on SPARC Solaris, requires version 8.5.5.11.
